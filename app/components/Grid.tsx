        ...
        <section id="portfolio" className="bg-neutral-900/40 border-y border-neutral-800">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Job link="https://youtu.be/Q6MU7rZ9OMY" title="Institucional Fibraw" description="Cliente • 2025 • Motion" image={fibraw}/>
                    <Job link="https://youtu.be/9vBLhxoOzxE" title="AgriShow 2025" description="Canal Rural • 2025 • Captação" image={agrishow}/>
                    <Job link="https://youtu.be/o37egYio23M" title="Showreel: Renan Mazer" description="Renan Mazer • 2025 • Captação" image={renanMazer}/>
                    <Job link="https://youtu.be/9xWoFBFOPAE" title="Mini Documentário: O Novo Kids" description="Ágape Igreja Missionária • 2025 • Captação" image={novokids}/>
